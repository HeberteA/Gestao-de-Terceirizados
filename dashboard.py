...
def render_dashboard(df_raw, df_view, sheet_url, lista_obras, lista_servicos):
    st.link_button("Adicionar Fornecedor", "https://gestao-de-terceirizados-lavie.streamlit.app/#cadastrar-novo-fornecedor", key=f"bgt_{index}", use_container_width=True) 
    st.markdown("---")
